...
// [[Rcpp::export]]
arma::vec emmix_t(arma::vec dat, int g, arma::mat params){
  int n = dat.size();
  ...
  arma::mat test1 = estep(dat,params);
  tau = test1.rows(0,g-1);
  you = test1.rows(g,2*g-1);
  arma::mat test2 = mstep(dat, tau, you, params);
