...
```{r, fig.show='hold', echo=FALSE, results='hide', cache=TRUE, message='hide'}
alon_top_50<-top_genes_cluster_tissues(alon_sel, 50, method='mfa', q=6, g=2)
...
groups<-20
alon_clus_20 <- cluster_genes(alon_sel, groups)
alon_clus_20_t1<-all_cluster_tissues(gen=alon_sel, clusters=alon_clus_20, q=6, G=2)
alon_clus_20_t2<-cluster_tissues(alon_sel, alon_clus_20, method='t')
cat(c("C1: ", paste(which(alon_clus_20$clustering==1)),"\n"))
cat(c("C2: ", paste(which(alon_clus_20$clustering==0)),"\n"))
```
...
alon_clus_20_t1<-all_cluster_tissues(gen=alon_sel, clusters=alon_clus_20, q=6, G=2)
alon_clus_20_t2<-cluster_tissues(alon_sel, alon_clus_20, method='t')
alon_clus_20_t3<-cluster_tissues(alon_sel, alon_clus_20, method='mfa', q=4)
```


```{r, echo=F, fig.show='hold'} 
j=1
plot<-heat_maps(alon_sel$genes[alon_clus_20==j,], alon_clus_20_t3[j,], paste0("Genes from Group G",j))
print(plot)
cat(c("C1: ", paste(which(alon_clus_20_t3[j,]==1)),"\n"))
cat(c("C2: ", paste(which(alon_clus_20_t3[j,]==0)),"\n"))
```
...
5.1.3
```{r, echo=F,  cache=TRUE, message='hide'}
cat(c("C1: ", paste(which(alon_clus_20_t1==1)),"\n"))
cat(c("C2: ", paste(which(alon_clus_20_t1==0)),"\n"))
```
...
```{r, echo=F,  cache=TRUE,message='hide'}
groups<-40
golub_clus_40 <- cluster_genes(golub, groups)
golub_clus_40_t1<-all_cluster_tissues(gen=golub, clusters=alon_clus_20, q=8, G=2)
golub_clus_40_t2<-cluster_tissues(golub_sel, golub_clus_40, method='t')
golub_clus_40_t3<-cluster_tissues(golub_sel, golub_clus_40, method='mfa', q=4)
```


```{r, echo=F, fig.show='hold'} 
j=1
plot<-heat_maps(golub_sel$genes[golub_clus_40==j,], golub_clus_40_t3[j,], paste0("Genes from Group G",j))
print(plot)
cat(c("C1: ", paste(which(golub_clus_40_t3[j,]==1)),"\n"))
cat(c("C2: ", paste(which(golub_clus_40_t3[j,]==0)),"\n"))
```
...
```{r, echo=F,cache=TRUE, message='hide'}
groups<-40
golub_clus_40 <- cluster_genes(golub_sel, groups)
golub_clus_40_t1<-all_cluster_tissues(gen=golub_sel, clusters=golub_clus_40, q=8, G=2)
golub_clus_40_t2<-cluster_tissues(golub_sel, golub_clus_40, method='t')
golub_clus_40_t3<-all_cluster_tissues(gen=golub_sel, clusters=golub_clus_40, q=6, G=3)
```


```{r, echo=F, fig.show='hold'} 
cat(c("C1: ", paste(which(golub_clus_40_t1==1)),"\n"))
cat(c("C2: ", paste(which(golub_clus_40_t1==0)),"\n"))
```
...
```{r, echo=F, fig.show='hold'} 
cat(c("C1: ", paste(which(golub_clus_40_t3==0)),"\n"))
cat(c("C2: ", paste(which(golub_clus_40_t3==1)),"\n"))
cat(c("C3: ", paste(which(golub_clus_40_t3==2)),"\n"))
```
