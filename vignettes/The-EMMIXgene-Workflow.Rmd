...
library(Biobase)
data(colonCA)
alon_data<-log(Biobase::exprs(colonCA))
...
plot_single_gene(alon_data,201, min =4, max=10)
plot_single_gene(alon_data,202,g=3, min =4, max=10)
```

```{r, fig.show='hold', cache=T}
plot_single_gene(alon_data, 202, g=2, min =4, max=10)
```
